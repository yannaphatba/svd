...
|--------------------------------------------------------------------------
| 
| เราจะใช้ Route::prefix('sdv') เพื่อให้ Laravel รับรู้ว่า URL หลักคือ /sdv
| วิธีนี้จะแก้ปัญหา 404 และทำให้ฟังก์ชัน redirect() ทำงานถูกต้องครับ
|
*/

Route::prefix('sdv')->group(function () {

    // 1. หน้าแรกของโครงการ (https://.../sdv) ให้ไปที่ Login
    Route::get('/', function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // Student Group (Path จะกลายเป็น /sdv/student/...)
        ...
        // Admin Group (Path จะกลายเป็น /sdv/admin/...)
        ...
        // Security Group (Path จะกลายเป็น /sdv/security/...)
